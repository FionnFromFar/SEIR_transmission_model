...
plt.title(f"SEIR model with beta={beta:.2f}, sigma={sigma:.2f}, gamma={gamma:.2f} (R0={R0:.2f})")
plt.legend()
plt.savefig("graphs/seir_R0_low.png", dpi=300) #having to save the graph as an image because im running in a linux terminal
print(f"The initial growth rate of this simulation was: {R0:.2f}")
print("Graph saved as 'seir_R0_low.png' in graphs folder")
